...
final class ProfileViewModel: ObservableObject {
    ...
    private let folderName = "profileImage"
    ...
    func getImage() -> UIImage? {
        if let imageName = userProfile?.userId, let savedImage = fileManager.getImage(imageName: imageName, folderName: folderName) {
            print("returning from file manager")
            return savedImage
        } else {
            print("returning from internet")
            return nil
        }
    }
